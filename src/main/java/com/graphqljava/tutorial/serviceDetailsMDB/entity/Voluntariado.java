...
public class Voluntariado extends Servicio{
    ...
    public Voluntariado(String nombre, String descripcion, EstadoServicio estado, String objetivo, int duracion, List<String> actividades, List<String> requerimientos, double ubicacionLatitud, double ubicacionLongitud, String nombreUbicacion, double costo, List<String> beneficios) {
        this.nombre = nombre;
