...
public class Hospedaje extends Servicio{
    ...
    public Hospedaje(String nombre, String descripcion, EstadoServicio estado, TipoHospedaje tipoHospedaje, int capacidadMaxima, int dias, int noches, LocalTime horaCheckOut, List<String> serviciosIncluidos, double ubicacionLatitud, double ubicacionLongitud, String nombreUbicacion) {
        this.nombre = nombre;
